...
for time_shift in time_shifts:
    ...
    for session in sessions:
        ...
        for run in folder_names:
            ...
            brain_file = run + "_var_residuals_time" + str(time_shift) + ".txt" 
            ...
            output_filename = run + "_var_mask02_trained_lasso_cj_" + out_snippet + ".pckl"
            save_pickle(output_path, output_filename, [lasso_alpha, lasso_betas, lasso_intercept])

            output_filename = run + "_var_mask02_X_mean_" + out_snippet + ".pckl"
